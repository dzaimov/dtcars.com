...
public class Admin extends User implements IAdmin {
	...
	public Admin(int id, String email, String password) throws InvalidEmailException, InvalidPasswordException {
	...
	public static void addEditAdForApproving(long id, int price, Set<Photo> photos, String additionalInfo)
			throws AdException {
